...
## 14. 2-Minute Video Script

**[OPENING — 0:00 to 0:15]**

*[Visuals: Ravi on his bike, rain pouring, roads flooded, phone showing zero orders]*

> **Narrator (VO):**
> "Meet Ravi. He delivers food for Swiggy in Hyderabad. Today — like 15 days every monsoon — he can't work. No orders. No income. No safety net.
> For 12 million delivery workers across India, this is everyday reality."

---

**[PROBLEM — 0:15 to 0:35]**

*[Visuals: rainfall forecast app, AQI meter hitting 350, curfew notification on phone]*

> **Narrator (VO):**
> "Rain. Extreme heat. Dangerous air quality. Curfews. Platform outages.
> These aren't rare events — they happen multiple times a month.
> And every time they do, India's gig workers lose 20 to 30 percent of their income.
> Traditional insurance? Too complex. Too slow. Too expensive."

---

**[SOLUTION — 0:35 to 1:00]**

*[Visuals: GigShield app onboarding, plan selection, progress ring showing coverage]*

> **Narrator (VO):**
> "Introducing GigShield — India's first AI-powered parametric income insurance built exclusively for delivery workers.
> For as little as ₹50 a week, Ravi gets up to ₹1,000 in income protection.
> No paperwork. No waiting. No claims to file."

---

**[HOW IT WORKS — 1:00 to 1:30]**

*[Visuals: Split screen — rain hitting Hyderabad, GigShield trigger alert firing, ₹350 UPI notification]*

> **Narrator (VO):**
> "When heavy rain hits Ravi's delivery zone and crosses our safety threshold, GigShield's AI triggers automatically.
> It checks his location, verifies he was actively working, calculates his income loss — and transfers ₹350 directly to his UPI ID.
> All within 2 hours. No forms. No calls. No waiting."

*[Visuals: Fraud detection screen with behavioral score, then 'Approved' in green]*

> **Narrator (VO):**
> "Our multi-layer fraud detection engine uses GPS signals, phone sensors, and platform activity to ensure every rupee goes to workers who genuinely deserve it."

---

**[IMPACT — 1:30 to 1:50]**

*[Visuals: map of India lighting up with GigShield zones, worker earnings dashboard, smiling workers]*

> **Narrator (VO):**
> "GigShield isn't just insurance.
> It's financial dignity for the workers who feed India.
> Powered by AI. Delivered in seconds. Available in your language — Telugu, Hindi, Tamil, and more."

---

**[CALL TO ACTION — 1:50 to 2:00]**

*[Visuals: GigShield logo, tagline]*

> **Narrator (VO):**
> "GigShield. **Because every delivery worker deserves a safety net.**"

*[End card: GigShield logo + tagline + Team Name + DEVTrails 2026]*
